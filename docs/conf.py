...
# -*- coding: utf-8 -*-
#
# Qt4_GenGUI documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'qt4_gengui','_version.py')
...
htmlhelp_basename = 'Qt4_GenGUIdoc'
...
latex_documents = [
  (master_doc, 'Qt4_GenGUI.tex', u'Qt4_GenGUI Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'Qt4_GenGUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Qt4_GenGUI', u'Qt4_GenGUI Documentation',
   author, 'Qt4_GenGUI', 'One line description of project.',
   'Miscellaneous'),
]
