...
class xlChart:
    ...
    def setMarkerStyle(self, NSeries=1, style='square'):
        if style=='square':
            self.chart.SeriesCollection(NSeries).MarkerStyle = constants.xlMarkerStyleSquare
        elif style=='triangle':
            self.chart.SeriesCollection(NSeries).MarkerStyle = constants.xlMarkerStyleTriangle
        else:
...
'''
    ...
    def setYScaleTypeOnSecondary(self, log=1):
        if log:
            self.chart.Axes(constants.xlValue, constants.xlSecondary).ScaleType = constants.xlLogarithmic
            #self.chart.Axes(constants.xlValue, constants.xlSecondary).AxisBetweenCategories = 1
            self.chart.Axes(constants.xlValue, constants.xlSecondary).MinorTickMark = constants.xlTickMarkCross
            self.chart.Axes(constants.xlValue, constants.xlSecondary).HasMinorGridlines = 1  # turn on grid for x axis
            self.chart.Axes(constants.xlValue, constants.xlSecondary).MinorGridlines.Border.LineStyle = constants.xlDot  # make grid style dots
            self.chart.Axes(constants.xlValue, constants.xlSecondary).MajorGridlines.Border.LineStyle = constants.xlContinuous
        else:
            self.chart.Axes(constants.xlValue, constants.xlSecondary).ScaleType = constants.xlScaleLinear
