"""A setuptools based setup module for Qt4_GenGUI

See:
http://qt4_gengui.readthedocs.org/en/latest/
https://github.com/sonofeft/Qt4_GenGUI

If installing from source, then
the best way to install Qt4_GenGUI is to use pip after navigating to the source directory::
...
target_file = path.join( here, 'qt4_gengui','_version.py')
...
setup(
    ...
    description = 'A generic GUI built with pyQt4. Used as starting point for new GUI apps.',
    long_description = long_description,

    # The project's main homepage.
    url='http://qt4_gengui.readthedocs.org/en/latest/',
    download_url='https://github.com/sonofeft/Qt4_GenGUI',
    ...
    package_data = {'qt4_gengui':['examples/*.*','images/*.*','html/*.*',
                    'html/_static/*.*', 'html/_images/*.*']},
    ...
    test_suite='qt4_gengui.tests', # allows "setup.py test" to work
    ...
    entry_points = {
        'console_scripts': [
            'qt4_gengui=qt4_gengui.gui_main:main',
        ],
    },
)